...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/emailvalidator',
        'Source': 'https://github.com/apiverve/emailvalidator-api',
        'Bug Tracker': 'https://github.com/apiverve/emailvalidator-api/issues'
    },
    classifiers=[
